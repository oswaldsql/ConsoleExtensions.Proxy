// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConsoleStyle.cs" company="Lasse Sjørup">
...
namespace ConsoleExtensions.Proxy
{
    ...
    public class ConsoleStyle
    {
        ...
        /// </summary>
        public static ConsoleStyle Default { get; } =
            new ConsoleStyle("Default", ConsoleColor.Gray, ConsoleColor.Black);
        ...
        /// </summary>
        public static ConsoleStyle Warning { get; } =
            new ConsoleStyle("Warning", ConsoleColor.Yellow, ConsoleColor.Black);
